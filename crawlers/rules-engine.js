...
/** 科目标准化映射（按辅导员考情大表归纳；P1C 扩展长尾归并：辅导员/思政/技能/业务岗位类） */
const SUBJECT_ALIASES = [
  [/辅导员/, '辅导员知识'],
  [/思想政治/, '思想政治'],
  [/公共基础(?:知识)?|公基(?!础)|常识/, '公共基础知识'],
  [/行政职业能力测验|职业能力倾向测验|职业能力测试|行政能力测试|行政能力测验|职测|行测/, '职业能力倾向测验'],
  [/综合应用能力(?:测试|测验)?/, '综合应用能力'],
  [/综合(?:基础)?知识(?:测试|测验)?|综合素养(?:测试|测验)?/, '综合知识'],
  [/申论/, '申论'],
  [/教育(?:综合)?基础(?:知识)?|高等教育基础(?:知识)?/, '教育基础知识'],
  [/高等教育教学基础(?:知识)?/, '教育教学基础知识'],
  [/教育(?:学|理论)|教育教学理论/, '教育基础知识'],
  [/高等教育心理学|教育心理学/, '教育心理学'],
  ...
  [/临床医学/, '临床医学'],
  [/技能(?!型)/, '专业技能'],
  [/专业基础(?:知识)?|岗位专业(?:相关)?知识|专业知识|业务(?:知识|能力)?|岗位(?:相关)?知识|专业技术(?:知识)?|学科(?:知识)?/, '专业知识'],
  [/写作/, '写作'],
  [/时事政治/, '时事政治'],
  [/法律法规/, '法律法规'],
  [/基础知识|基本理论/, '综合知识'],
...
export { autoFix, normalizeText, normalizeSubject };
